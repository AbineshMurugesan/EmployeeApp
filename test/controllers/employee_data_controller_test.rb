...
class EmployeeDataControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create employee_datum" do
    assert_difference("EmployeeDatum.count") do
      post employee_data_url, params: { employee_datum: { age: @employee_datum.age, designation: @employee_datum.designation, gender: @employee_datum.gender, name: @employee_datum.name } }
    end
  ...
  test "should update employee_datum" do
    patch employee_datum_url(@employee_datum), params: { employee_datum: { age: @employee_datum.age, designation: @employee_datum.designation, gender: @employee_datum.gender, name: @employee_datum.name } }
